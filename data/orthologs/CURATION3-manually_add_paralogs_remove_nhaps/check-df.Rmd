...
# protein sequence for the old dataset -- compare the effect of taking out the NHE sequences, but not nhaps 
sink("2023-03-22-NHEless.fasta")
for(i in 1:nrow(data)){
  cat(data$fasta.names[i])
  cat("\n")
  cat(data$protein.sequence)
  cat("\n")
}
```
